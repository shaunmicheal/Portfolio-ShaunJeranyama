...
function About() {
  return (
    <section className="bg-black flex flex-col gap-16 px-16 py-20">
      <div className="flex items-center justify-between gap-12">
        <div>
          <img
            src={AboutPic}
            alt="Shaun Jeranyama"
            className="w-80 rounded-2xl object-cover animate-float"
          />
        </div>
      ...
      <div className="flex gap-8 justify-center">
        <div className="bg-zinc-900 rounded-xl w-48 px-8 py-6 text-center hover:bg-zinc-800 hover:-translate-y-2 transition duration-300 cursor-pointer">
